create if not exists table crops (
...
create if not exists table estate (
...
create if not exists table plantation (
...
create if not exists table crops_plantations (
...
create if not exists table worker (
...
create if not exists table worker_family_member (
...
create if not exists table landlord (
...
create if not exists table evidence_info (
...
create if not exists table manager (
